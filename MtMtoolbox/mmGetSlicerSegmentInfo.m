function T = mmGetSlicerSegmentInfo(file_name,options)
%MMGETSLICERSEGMENTINFO Reads in the metadata from a Slicer Segmentation file (seg.nrrd) 
...
% EXAMPLE
%
% segT = mmGetSlicerSegmentInfo(file_name)
%
